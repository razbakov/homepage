---
title: "What Level of AI Are You On? From Q&A to Ikigai"
description: "Most people use AI to ask questions. But there are 10 levels of AI mastery — and the highest one has nothing to do with technology. A recap of Learn By Doing Academy Live Stream #1."
date: 2026-04-11
...
cta:
  label: "Watch the full livestream"
  url: "https://www.youtube.com/watch?v=tqAS8_VQZGE"
---

Most people use ChatGPT as a search engine replacement. That is Level 1. There are nine more levels after that, and the highest one has nothing to do with technology at all.

I ran the first live stream for [Learn By Doing Academy](https://learn-by-doing-academy.com) on Saturday. What started as a casual walkthrough of AI tools turned into a 90-minute conversation about agents, recursion, philosophy, and finding your purpose. Here is what we covered.
...
I recommended [CS50](https://cs50.harvard.edu/) as the foundational course for anyone who wants to understand recursion, which is the core concept behind agentic AI.
...
Start with a [free 15-minute discovery call](https://learn-by-doing-academy.com) to see if it is a fit.
