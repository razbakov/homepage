...
It is not a new idea. An organization called [Democracy Earth](https://democracy.earth/) wrote a whitepaper about it back in 2017. They built a protocol, got into Y Combinator, and then went dormant around 2022.
...
That is what I have been building with [Ikigai Team](https://ikigai.razbakov.com). It starts with a coaching session, not a configuration file. An AI coach helps you reflect on what matters to you, scores ten areas of your life, and finds your direction. Then your AI team is calibrated to those values.
...
1. **Now:** Build the personal governance layer. Get people running their own AI teams calibrated to their values. This is Ikigai Team, and it already works.

2. **Next:** Add trust circles. Let people delegate specific decisions to humans they actually know. Your doctor friend for health, your teacher friend for education.

3. **Then:** Connect the circles. Enable liquid democracy across a network of personal AI teams. P2P, encrypted, verifiable. Like torrents, but for governance.

4. **Parallel:** Start small resource experiments. Sensor networks in a community. Shared resource allocation. Prove that Layer 1 works at small scale.

5. **Converge:** Connect the governance layer to the resource layer in a real community. Show that it works.

6. **Scale:** Let results speak for themselves.
