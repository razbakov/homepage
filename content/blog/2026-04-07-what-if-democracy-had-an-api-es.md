...
No es una idea nueva. Una organización llamada [Democracy Earth](https://democracy.earth/) escribió un whitepaper al respecto en 2017. Construyeron un protocolo, entraron en Y Combinator y luego quedaron inactivos alrededor de 2022.
...
Eso es lo que he estado construyendo con [Ikigai Team](https://ikigai.razbakov.com). Empieza con una sesión de coaching, no con un archivo de configuración. Un coach de IA te ayuda a reflexionar sobre lo que te importa, puntúa diez áreas de tu vida y encuentra tu dirección. Luego tu equipo de IA se calibra según esos valores.
...
1. **Ahora:** Construir la capa de gobernanza personal. Hacer que las personas ejecuten sus propios equipos de IA calibrados según sus valores. Esto es Ikigai Team, y ya funciona.

2. **Siguiente:** Añadir círculos de confianza. Permitir que las personas deleguen decisiones específicas a humanos que realmente conocen. Tu amigo médico para salud, tu amigo profesor para educación.

3. **Después:** Conectar los círculos. Habilitar la democracia líquida a través de una red de equipos de IA personales. P2P, cifrado, verificable. Como torrents, pero para la gobernanza.

4. **En paralelo:** Comenzar experimentos pequeños con recursos. Redes de sensores en una comunidad. Asignación compartida de recursos. Demostrar que la Capa 1 funciona a pequeña escala.

5. **Converger:** Conectar la capa de gobernanza con la capa de recursos en una comunidad real. Demostrar que funciona.

6. **Escalar:** Dejar que los resultados hablen por sí mismos.
...
*Estoy construyendo esto de forma abierta. El código está en [github.com/razbakov/ikigai-team](https://github.com/razbakov/ikigai-team). La investigación sobre gobernanza está en [agora.razbakov.com](https://agora.razbakov.com). Si algo de esto resuena contigo, me encantaría saber de ti.*
